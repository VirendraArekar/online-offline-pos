...
export default function Customer(props) {
  ...
  const getCategoryList = () => {
    getApi('/Tax/list').then(data => {
      if (data) {
        console.log('Discount list ----', data)
        // setCategoryList(data || []);
        setCategoryList([{
            "uuid": "56b9e5c6-6dd8-48df-b58b-11575a9d224e",
            "name": "SGST",
            "type": 0,
            "price": 6
        }])
  ...
  const columns = [
    ...
    {
      name: 'Approch Type',
      selector: row => row.type ? 'Added to Price' : `Included In the Price`,
      sortable: true,
      ...
      >
        <div className='row'>
          <div className='col-12 my-3 px-5'>
            <div className="card-body">
              <h4 className='mb-4 mt-3'>{capitalizeFirstLetter(action)} Tax</h4>
              ...
              <div className='row'>
                  ...
                  <div class="mb-2 my-1">
                    <label for="type" class="form-label"><span className='text-danger'>*</span> Approach type</label>
                    <br></br>
